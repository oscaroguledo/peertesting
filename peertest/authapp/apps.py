...
# Define a new application configuration class named AuthappConfig
class AuthappConfig(AppConfig):
    ...
    name = 'authapp'  # This is the name of the app, and it should match the name used in the INSTALLED_APPS setting
